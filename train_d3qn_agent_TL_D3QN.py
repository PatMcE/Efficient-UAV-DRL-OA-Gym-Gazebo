...
class D3QNAgent(object):
    def __init__(self, n_actions, input_dims, eps_start, eps_min, eps_dec, save_load_dir, pretrained_path=None, num_rel_positions=2, gamma=0.99, lr=0.000025, batch_size=64, mem_size=100000, replace=1000):
