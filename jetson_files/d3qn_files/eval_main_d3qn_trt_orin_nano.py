...
import drone_gym_gazebo_env_discrete #defines 'DroneGymGazeboEnvDiscrete-v0' custom environment
import gym
import numpy as np
import rospy
import argparse
...
ENGINE_PATH = '/home/pm/catkin_ws/src/mavros-px4-vehicle/models/D3QN_eval_half.trt'

if __name__ == '__main__':
	parser = argparse.ArgumentParser(description = 'Drone StableBaselines')
	parser.add_argument('-episodes', type=int, default=100)#100 episodes used to determine inference latency/success rate
	args = parser.parse_args()

	# Initialize/create ROS node and custom gym environment:
	rospy.init_node('drone_node', anonymous=True)
	env = gym.make('DroneGymGazeboEnvDiscrete-v0') #'DroneGymGazeboEnvDiscrete-v0' is the custom gym environment from drone_gym_gazebo_env
