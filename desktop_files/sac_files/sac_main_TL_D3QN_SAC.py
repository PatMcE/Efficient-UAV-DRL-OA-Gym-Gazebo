...
if __name__ == "__main__":
    ...
    parser.add_argument("-ep", type=int, default=1500, help="The amount of training episodes, default is 100")#2000
    ...
    agent = Agent(state_size=(env.observation_space.shape), action_size=action_size, actor_lr=args.actor_lr,
                  ...
                  hidden_size=args.hidden_size, action_prior="uniform", pretrained_path=save_load_dir+'D3QN_old.pth')
    ...
    for i_episode in range(1, args.ep + 1):
        ...
        # Check for reaching a minimum reward if it hasn’t been recorded yet
